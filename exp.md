...
- keep `d_model=128`, `dim_feedforward=512`, `dropout=0.0`, `learning_rate=7.5e-4` as the current best timed candidate
- test nearby learning rates such as `6e-4` or `9e-4`
- compare every new timed run against `2.7349` for the current best timed result
