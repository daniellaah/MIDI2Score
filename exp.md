...
- keep `d_model=128`, `dim_feedforward=512`, `dropout=0.0` as the current best timed candidate
- test `learning_rate=7.5e-4` or `1.5e-3` under the current best structural settings
- compare every new timed run against `2.7713` for the current best timed result
